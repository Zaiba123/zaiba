...
const WorkAndProjects = ({style}) => {
    const project =
        [
            {
                name:"In-chat-nito",
                description:"Application allows students who are shy to ask the teacher questions in chatroom in real-time. Used React.js as well as Socket.io to create real time chat rooms for students to ask questions in anonymously.",
                img: inChatNito,
