    ...
    return (
        ...
        <div className="bio-container">
            ...
            <div className="intro">
                ...
                creatvity into reality. In my spare time I love exploring the city and finding new places to eat and blog about them on my instagram page. A fun fact about me is that I can solve a rubik cube in less than 30 seconds.
                <br/>
